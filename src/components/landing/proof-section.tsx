    ...
    >
      <div className={shell}>
        <header className="max-w-3xl" data-motion="rise">
          ...
          <p className="mt-4 max-w-2xl text-[17px] font-semibold leading-8 text-[#62665e] max-sm:text-base max-sm:leading-7">
