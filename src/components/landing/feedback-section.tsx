...
export function FeedbackSection() {
  return (
    <section className={`${section} bg-cream`} id="feedback" aria-labelledby="feedback-title">
      <div className={shell}>
        <div className="mb-12 max-w-[760px] text-center max-sm:mb-7 max-sm:text-left md:text-left">
        ...
        <div className="mt-10 flex flex-col gap-4 border-t border-[rgba(113,121,113,0.18)] pt-8 max-sm:mt-7 max-sm:pt-6 sm:flex-row sm:items-center sm:justify-between">
