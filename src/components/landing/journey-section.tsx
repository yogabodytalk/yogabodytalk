      ...
      <div className="mx-auto w-[min(1200px,calc(100%_-_40px))]">
        <div className="grid items-center gap-12 max-sm:gap-6 md:grid-cols-2 lg:gap-16">
          <div data-motion="rise">
            ...
            <h2 id="journey-title" className="font-serif text-[clamp(2.05rem,3.4vw,3rem)] font-medium leading-[1.16] text-[#285A38] max-sm:text-[1.85rem]">
            ...
            <div className="mt-5 grid grid-cols-3 gap-2 rounded-xl border border-[rgba(193,201,191,0.58)] bg-white/70 p-2 text-center text-[0.62rem] font-semibold uppercase leading-4 tracking-[0.08em] text-[#285A38] md:hidden">
              <span className="rounded-lg bg-[#F6F1DF] px-2 py-3">Bộ khung</span>
              <span className="rounded-lg bg-[#F6F1DF] px-2 py-3">Nhiên liệu</span>
              <span className="rounded-lg bg-[#F6F1DF] px-2 py-3">Cầm lái</span>
            </div>
          </div>
          <BodyMachineDiagram />
        </div>

        <div className="mt-16 grid gap-7 max-sm:mt-8 max-sm:gap-3 md:grid-cols-3 lg:gap-8" aria-label="Ba yếu tố của cỗ máy cơ thể">
          {bodyMachinePrinciples.map((item, index) => (
            <article className="rounded-xl border border-[rgba(193,201,191,0.62)] bg-white/70 p-8 shadow-[0_22px_60px_rgba(40,90,56,0.06)] transition hover:-translate-y-1 hover:bg-white md:min-h-[280px] lg:p-11 max-sm:grid max-sm:min-h-0 max-sm:grid-cols-[42px_minmax(0,1fr)] max-sm:gap-x-3 max-sm:p-4 max-sm:shadow-none" key={item.title} data-motion="rise" data-motion-delay={String(index * 90)}>
              ...
              <h3 className="font-serif text-[1.45rem] font-medium leading-[1.22] text-[#285A38] lg:text-[1.8rem] max-sm:text-xl">{item.title}</h3>
        ...
        <div className="relative mx-auto mt-16 max-w-[1180px] max-sm:mt-8 lg:mt-20">
          ...
          <div className="grid gap-5 max-sm:gap-4 md:grid-cols-2 lg:grid-cols-4" aria-label="Hành trình chuyển hóa 4 bước">
            {journeySteps.map((item, index) => (
              <article className="relative z-10 rounded-xl border border-[rgba(193,201,191,0.56)] bg-[#FDFCF8] p-6 text-left shadow-[0_18px_50px_rgba(40,90,56,0.05)] max-sm:grid max-sm:grid-cols-[44px_minmax(0,1fr)] max-sm:gap-x-3 max-sm:border-0 max-sm:bg-transparent max-sm:p-0 max-sm:shadow-none md:min-h-[250px] lg:min-h-[280px]" key={item.number} data-motion="rise" data-motion-delay={String(120 + index * 90)}>
                <div className="flex h-16 w-16 items-center justify-center rounded-full border border-[#E8C266] bg-[#F6F5EF] text-sm font-semibold text-[#9d7610] shadow-[0_0_0_8px_#F6F5EF] max-sm:h-10 max-sm:w-10 max-sm:text-xs md:mb-8">
                  {item.number}
                </div>
                <h3 className="font-serif text-[1.38rem] font-medium leading-[1.22] text-[#285A38] max-sm:mt-0 max-sm:text-lg">{item.title}</h3>
        ...
        <div className="mt-16 flex justify-center max-sm:mt-8 max-sm:justify-start" data-motion="rise">
          <a className="inline-flex items-center gap-2 border-b border-[#E8C266] pb-1 text-sm font-bold uppercase tracking-[0.06em] text-[#285A38] transition hover:text-[#b08a1c] max-sm:min-h-11" href="#contact">
